...
use Modules\Customer\Listeners\LogVatActivity;
...
class CustomerServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // HOOK — entity lifecycle (HasLifecycleHooks) untuk 3 entity modul.
        foreach (['created', 'updated', 'deleted'] as $event) {
            ...
            Event::listen(\Spine\Events\EntityCreated::class, LogVatActivity::class . '@created');
            Event::listen(\Spine\Events\EntityUpdated::class, LogVatActivity::class . '@updated');
            Event::listen(\Spine\Events\EntityDeleted::class, LogVatActivity::class . '@deleted');
        }
    }
}
